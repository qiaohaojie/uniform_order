...
// catalog items adapted from the IMHS paper form, and one parent (Alex Taylor).
...
// Catalog — modelled on the IMHS paper form. Each item has variants with size
...
const CATALOG_IMHS = [
  ...
  { id: 'cap', cat: 'Summer', name: 'School Cap, Navy',
    desc: 'Embroidered IMHS crest. One size, adjustable strap.',
...
const ADMIN_ORDERS = [
  { id: 'IMHS-04298', parent: 'Alex Taylor', kid: 'Tim Taylor', year: 'Year 9', items: 6, total: 363, placed: '27 Apr · 9:42am', status: 'new', delivery: 'pickup', email: 'support@uniformorder.online' },
  ...
  { id: 'IMHS-04294', parent: 'Diego Moreno',kid: 'Mateo Moreno',year: 'Year 9', items: 3, total: 95,  placed: '26 Apr · 2:18pm', status: 'packing', delivery: 'pickup' },
  { id: 'IMHS-04293', parent: 'Anna Kovac',  kid: 'Luka Kovac',  year: 'Year 10', items: 5, total: 240, placed: '26 Apr · 11:02am', status: 'ready', delivery: 'pickup' },
  { id: 'IMHS-04292', parent: 'Mei Zhang',   kid: 'Oliver Zhang',year: 'Year 7', items: 7, total: 388, placed: '25 Apr · 5:41pm', status: 'ready', delivery: 'pickup' },
  { id: 'IMHS-04291', parent: 'Tom Reilly',  kid: 'Sam Reilly',  year: 'Year 12', items: 1, total: 22,  placed: '25 Apr · 1:09pm', status: 'collected', delivery: 'pickup' },
  { id: 'IMHS-04290', parent: 'Priya Singh', kid: 'Aarav Singh', year: 'Year 8', items: 4, total: 168, placed: '24 Apr · 4:20pm', status: 'collected', delivery: 'pickup' },
];

// Multi-tenant — Super-admin lists all schools on the platform.
const PLATFORM_TENANTS = [
  { id: 'imhs', name: 'Illawarra Modern High School',  short: 'IMHS',  parents: 1240, orders30d: 312, mrr: 0,  plan: 'Standard', status: 'active', since: 'Jan 2025', accent: '#7A1F2B' },
  { id: 'rgsh', name: 'Riverside Academy',    short: 'RGHS',  parents: 980,  orders30d: 244, mrr: 0,  plan: 'Standard', status: 'active', since: 'Mar 2025', accent: '#2F5D50' },
...
// Sales dashboard mock numbers (operator view, last 30 days for IMHS).
const SALES = {
  revenue: 18420,
  orders: 312,
  avgOrder: 59.04,
...
export {
  ...
  TENANTS, SIZES_GENERIC, CATALOG_IMHS, SAMPLE_CART, PAST_ORDERS, ADMIN_ORDERS, PLATFORM_TENANTS, SALES,
};
