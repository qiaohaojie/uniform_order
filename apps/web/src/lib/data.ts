...
// adapted from the IMHS paper form, and one parent (Alex Taylor).
...
export const PARENT = {
  ...
  kids: [
    { name: "Tim", year: "Year 9", tenantId: "imhs" as TenantId },
    { name: "Sam", year: "Year 7", tenantId: "rgsh" as TenantId },
  ] satisfies Kid[],
};
