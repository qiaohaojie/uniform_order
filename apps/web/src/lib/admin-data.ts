...
const NSBH_ORDERS: AdminOrder[] = [
  {
    ...
    total: 280,
    stripeRef: "pi_3OrAqK",
    notes: "All shirts in original packaging. Riley wore size 14 last year, sized up by parent.",
  },
  {
    id: "NSBH-04297",
    tenantId: "nsbh",
...
export const ADMIN_ORDERS: AdminOrder[] = [...NSBH_ORDERS, ...RGSH_ORDERS];
