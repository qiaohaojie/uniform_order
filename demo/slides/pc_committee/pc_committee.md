...
- **Footer:** These figures match the workflow described in `demo/product_demo/product-walkthrough.md` §1; pilot data will refine them per school.
...
Read § 8 of `demo/product_demo/product-walkthrough.md` before drafting.
...
A P&C committee will smell exaggeration faster than any other audience in the demo corpus. They have personally done the work. Understatement reads as competence; overstatement reads as a sales pitch.
