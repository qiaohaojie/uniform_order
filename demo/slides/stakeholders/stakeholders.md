...
- **Australian English** consistent with the rest of the demo corpus.
...
- **Footer:** Each item above traces to the ✓ live rows in `demo/product_demo/product-walkthrough.md` § 8.
...
- **Footer:** Honesty calibration: nothing claimed here is shipped. Source: `demo/product_demo/product-walkthrough.md` § 5.
...
This is the deck where overstatement is most expensive — a stakeholder who catches a stretched claim mid-conversation costs the relationship. Read § 8 of `demo/product_demo/product-walkthrough.md` before drafting.
