...
const TENANTS = {
  nsbh: {
    id: 'nsbh', name: 'North Sydney Boys High School', short: 'NSBH', crest: 'NSBH',
    accent: '#7A1F2B', accentInk: '#FFFFFF',
  ...
  rgsh: {
    id: 'rgsh', name: 'Riverside Girls High School', short: 'RGHS', crest: 'RGHS',
    accent: '#2F5D50', accentInk: '#FFFFFF',
...
const SALES = {
  revenue: 18420, orders: 312, avgOrder: 59.04,
  topItems: [
