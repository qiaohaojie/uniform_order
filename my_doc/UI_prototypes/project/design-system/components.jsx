...
function Btn({ variant = 'primary', size = 'md', children, onClick, fullWidth, disabled, accent, style, leading, trailing, type = 'button' }) {
  const sizes = {
    sm: { h: 34, px: 12, fs: 13 },
    md: { h: 44, px: 18, fs: 14 },
    lg: { h: 52, px: 22, fs: 15 },
  ...
  return (
    <button type={type} onClick={onClick} disabled={disabled} className="btn"
      style={{ height: sizes.h, padding: `0 ${sizes.px}px`, fontSize: sizes.fs,
